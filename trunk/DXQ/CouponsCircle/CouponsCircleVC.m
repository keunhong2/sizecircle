...
-(void)screenBtnDone
{
    ...
    screen.selectClassName=[screenObj.classify isEqualToString:@"-1"]?@"不限":screenObj.classify;
    screen.selectLocationName=[screenObj.area isEqualToString:@"-1"]?@"不限":screenObj.area;
